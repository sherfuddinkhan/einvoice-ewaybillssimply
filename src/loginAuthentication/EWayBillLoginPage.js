  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", justifyContent: "center", alignItems: "center", background: "#F5F5F7", padding: "40px" }}>
      <div style={{ width: "420px", background: "#fff", borderRadius: "16px", padding: "30px", boxShadow: "0 8px 30px rgba(0,0,0,0.12)" }}>
        <h2 style={{ textAlign: "center", marginBottom: "25px" }}>🚚 E-Way Bill Login</h2>

        <label>Email</label>
        <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} style={{ width: "100%", padding: "12px", marginTop: "6px", marginBottom: "16px", borderRadius: "8px", border: "1px solid #707070", boxSizing: "border-box" }} />
        ...
        {response && (
          <div style={{ marginTop: "20px", padding: "16px", borderRadius: "10px", background: response.status === "SUCCESS" ? "#34A85322" : "#EA433522", border: `2px solid ${response.status === "SUCCESS" ? "#34A853" : "#EA4335"}` }}>
            ...
            <pre style={{ background: "#263238", color: "#A8FFBF", padding: "10px", borderRadius: "6px", marginTop: "10px", overflowX: "auto", fontSize: "12px" }}>
